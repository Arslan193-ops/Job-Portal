...
namespace Job_Portal.Controllers
{
    public class ApplicationsController : Controller
    {
        ...
        {
            var jobPortalContext = _context.Applications.Include(a => a.Job).Include(a => a.User);
        ...
        public async Task<IActionResult> Create([Bind("ApplicationId,JobId,UserId,AppliedDate")] Application application)
        {
